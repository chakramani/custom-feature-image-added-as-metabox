jQuery(document).ready(function($) {
	...
	jQuery.fn.upload_feature_image = function( button ) {
		...
		file_frame.on( 'select', function() {
		  ...
		  jQuery( '#remove_feature_image_button' ).text( 'Remove feature image' );
		});
	...
	jQuery('#featureimagediv').on( 'click', '#upload_feature_image_button', function( event ) {
		event.preventDefault();
		jQuery.fn.upload_feature_image( jQuery(this) );
	});

	jQuery('#featureimagediv').on( 'click', '#remove_feature_image_button', function( event ) {
		event.preventDefault();
		...
		jQuery( '#upload_feature_image_button' ).text( 'Set feature image' );
	});
